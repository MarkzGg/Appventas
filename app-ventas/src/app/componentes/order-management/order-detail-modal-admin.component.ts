...
@Component({
  selector: 'app-order-detail-modal-admin',
  template: `
...
export class OrderDetailModalAdminComponent {
  ...
  cerrarModal(): void {
    console.log('OrderDetailModalAdminComponent: cerrarModal called');
    if (this.onClose) {
      this.onClose();
    }
  }
  ...
  cerrarModalAlternativo(): void {
    console.log('OrderDetailModalAdminComponent: cerrarModalAlternativo called');
    if (this.onClose) {
      this.onClose();
    }
  }
